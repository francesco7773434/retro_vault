...
public class GiocoRunner implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        salvaGiocoSeNonEsiste("Galaga", "Un classico sparatutto arcade spaziale.", 1981, Genere.ARCADE, "https://upload.wikimedia.org/wikipedia/en/0/00/Galaga_Flyer.png", piattaforma1,"https://www.youtube.com/watch?v=dvjapcHsqXY");
        salvaGiocoSeNonEsiste("Doom", "Sparatutto in prima persona ambientato su Marte infestato.", 1993, Genere.SHOOTER, "https://upload.wikimedia.org/wikipedia/en/5/57/Doom_cover.png", piattaforma2,"https://www.youtube.com/watch?v=8mEP4cflrd4");
        salvaGiocoSeNonEsiste("Portal", "Puzzle game con portali e meccaniche innovative.", 2007, Genere.PUZZLE, "https://upload.wikimedia.org/wikipedia/en/f/f9/Portal_cover_art.jpg", piattaforma5,"https://www.youtube.com/watch?v=90yDSsZsgfA");
        salvaGiocoSeNonEsiste("Skyrim", "Un vasto RPG open world tra draghi e magia.", 2011, Genere.RPG, "https://upload.wikimedia.org/wikipedia/en/6/6f/Skyrim_cover_art.jpg", piattaforma5,"https://www.youtube.com/watch?v=eDh5TJcs7FU");
        salvaGiocoSeNonEsiste("Tomb Raider", "Un'avventura epica con Lara Croft.", 1996, Genere.ADVENTURE, "https://upload.wikimedia.org/wikipedia/en/8/8d/Tomb_Raider_Coverart.png", piattaforma4,"https://www.youtube.com/watch?v=I0r5pM-1Hgw");
        salvaGiocoSeNonEsiste("Mortal Kombat", "Il picchiaduro violento e iconico.", 1992, Genere.FIGHTING, "https://upload.wikimedia.org/wikipedia/en/9/9b/Mortal_Kombat_arcade_flyer.png", piattaforma2,"https://www.youtube.com/watch?v=lW7r2w8SsN0");
        salvaGiocoSeNonEsiste("Mario Kart 64", "Corse frenetiche con i personaggi Nintendo.", 1996, Genere.RACING, "https://upload.wikimedia.org/wikipedia/en/6/60/Mario_Kart_64_Cover_Art.jpg", piattaforma4,"https://www.youtube.com/watch?v=w8K-heSWX8s");
        salvaGiocoSeNonEsiste("FIFA 21", "Il calcio simulato con licenze ufficiali.", 2020, Genere.SPORTS, "https://upload.wikimedia.org/wikipedia/en/3/3e/FIFA_21_Cover_Art.jpg", piattaforma6,"https://www.youtube.com/watch?v=QJJX0vXDP4g");
        salvaGiocoSeNonEsiste("StarCraft", "Strategia in tempo reale tra razze aliene.", 1998, Genere.STRATEGY, "https://upload.wikimedia.org/wikipedia/en/5/59/StarCraft_cover_art.jpg", piattaforma7,"https://www.youtube.com/watch?v=Eg-jIWWemeQ");
        salvaGiocoSeNonEsiste("The Sims 4", "Simulazione di vita quotidiana e personalizzazione.", 2014, Genere.SIMULATION, "https://upload.wikimedia.org/wikipedia/en/7/7e/The_Sims_4_cover_art.png", piattaforma5,"https://www.youtube.com/watch?v=2BUHtqroKRw");
